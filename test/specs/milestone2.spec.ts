...
import { lessonSignUp, serverRequest, stripeRequest, VALID_CARD } from '../helpers';
...
test.describe('Paying for lessons', () => {
  ...
  test('Should Create a Payment Intent:4.1.2', async () => {
    ...
    expect(scheduleLessonResponse.charges.data[0].captured).toBe(false);
  ...
  test('Should Capture and Confirm the Payment Intent:4.2.2', () => {
    ...
    expect(completePaymentResponse.charges.data[0].captured).toBe(true);
